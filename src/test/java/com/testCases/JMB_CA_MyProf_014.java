...
public class JMB_CA_MyProf_014 extends BaseClass {
	
	@Test
	
	public void JMB_CA_MyProf() throws IOException 
	...
	MP.availablity();
	logger.info("Clicked on availability");
	
	MP.availablityDate();
	logger.info("Select the  availability");
